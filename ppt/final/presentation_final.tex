...
\item \hyperlink{problem}{Problem Statement}
\item \hyperlink{literature}{Literature Review}
\item \hyperlink{methodology}{Research Methodology}
\item \hyperlink{architecture}{System Architecture}
\item \hyperlink{features}{Key Features}
\item \hyperlink{ai}{AI Integration}
\item \hyperlink{implementation}{Implementation}
\item \hyperlink{demo}{Demo}
\item \hyperlink{deployment}{Deployment}
\item \hyperlink{future}{Future Scope}
...
\begin{frame}{Problem Statement}\label{problem}
\begin{itemize}
...
\begin{frame}{Research Methodology}\label{methodology}
...
\begin{frame}{System Architecture}\label{architecture}
\begin{center}
...
\begin{frame}{Key Features - Admin Dashboard}\label{features}
\begin{itemize}
...
\begin{frame}{AI Integration}\label{ai}
\begin{center}
...
\begin{frame}{Implementation}\label{implementation}
...
% Slide 12: Demo
\begin{frame}{Demo \& Testing}\label{demo}
\begin{center}
...
% Slide 13: Deployment
\begin{frame}{Deployment}\label{deployment}
...
\begin{frame}{Future Scope}\label{future}
...
% Slide 15: References
\begin{frame}{References}\label{references}
\tiny
\begin{enumerate}
